...
class TAC_SUV_Base: CUP_SUV_Unarmed_Base {
    ...
    HiddenSelectionsTextures[] = { "\x\gta\addons\arcadian\data\arcadian_body_co.paa" };
    // Damage & Hitpoints
    ...
    soundEngineOnInt[] = { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_Int_Start",0.630957,1 }; // Replaced
