...
class TACGT_SUV_Base: CUP_SUV_Unarmed_Base {
    ...
    HiddenSelectionsTextures[] = { "\x\tacgt\addons\arcadian\data\arcadian_body_black_co.paa" };
    // Damage & Hitpoints
...
#include "sounds.hpp"
    ...
    CLASS(Arcadian_B_SUV): TACGT_SUV_Base {
    scope = 2;
    scopeCurator = 2;
    scopeArsenal = 2;
    ...
    editorPreview = "\x\tacgt\addons\arcadian\ui\Arcadian_B_SUV.jpg";
    ...
    CLASS(Arcadian_B_SUV_Tan): TACGT_Arcadian_B_SUV {
    displayName = "GT Armory Arcadian Tan";
    HiddenSelectionsTextures[] = { "\x\tacgt\addons\arcadian\data\arcadian_body_earth_co.paa" };
    editorPreview = "\x\tacgt\addons\arcadian\ui\Arcadian_B_SUV_Tan.jpg";
    };

    CLASS(Arcadian_B_SUV_Green): TACGT_Arcadian_B_SUV {
    displayName = "GT Armory Arcadian Green";
    HiddenSelectionsTextures[] = { "\x\tacgt\addons\arcadian\data\arcadian_body_foliage_co.paa" };
    editorPreview = "\x\tacgt\addons\arcadian\ui\Arcadian_B_SUV_Green.jpg";
    };

    CLASS(Arcadian_I_SUV_Black): TACGT_Arcadian_B_SUV {
    ...
    CLASS(Arcadian_I_SUV_Tan): TACGT_Arcadian_I_SUV_Black {
    displayName = "GT Armory Arcadian Tan";
    HiddenSelectionsTextures[] = { "\x\tacgt\addons\arcadian\data\arcadian_body_earth_co.paa" };
    editorPreview = "\x\tacgt\addons\arcadian\ui\Arcadian_B_SUV_Tan.jpg";
    };

    CLASS(Arcadian_I_SUV_Green): TACGT_Arcadian_I_SUV_Black {
    displayName = "GT Armory Arcadian Green";
    HiddenSelectionsTextures[] = { "\x\tacgt\addons\arcadian\data\arcadian_body_foliage_co.paa" };
    editorPreview = "\x\tacgt\addons\arcadian\ui\Arcadian_B_SUV_Green.jpg";
    };
