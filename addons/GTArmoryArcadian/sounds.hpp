        class Sounds {
            class Idle_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM0","db-13",1,150 };
                range = "2.5 *210";
            ...
            class Engine {
                ...
                volume = "engineOn * 1.2 * 1.9  * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor[0, (900 - 800)/(3000 - 800) - (((900 - 800)/(3000 - 800) - 0) - (1.5 * ((900 - 800)/(3000 - 800) - 0)))/2]) * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor [(1100 - 800)/(3000 - 800) - (((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800)) - (1.5 * ((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800))))/2, (900 - 800)/(3000 - 800) + (((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800)) - (1.5 * ((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800))))/2])";
            };

            class Engine1_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM2",1,240 };
                range = "2.5 *215";
                frequency = "0.8 + ((rpm/7000) factor[(1300/7000),(3100/7000)])*0.2";
                volume = "engineOn * 1.2 * 1.9  * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor[(900 - 800)/(3000 - 800) + (((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800)) - (1.5 * ((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800))))/2, (1100 - 800)/(3000 - 800) - (((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800)) - (1.5 * ((1100 - 800)/(3000 - 800) - (900 - 800)/(3000 - 800))))/2]) * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor [(2000 - 800)/(3000 - 800) - (((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800)) - (1.5 * ((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800))))/2, (1100 - 800)/(3000 - 800) + (((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800)) - (1.5 * ((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800))))/2])";
            };

            class Engine2_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM3","db-8",1,280 };
                range = "2.5 *225";
            ...
            class Engine3_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM3","db-7",1,320 };
                range = "2.5 *225";
                frequency = "0.8 + ((rpm/7000) factor[(3300/7000),(4900/7000)])*0.2";
                volume = "engineOn * 1.2 * 1.9  * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor[(1100 - 800)/(3000 - 800) + (((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800)) - (1.5 * ((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800))))/2, (2000 - 800)/(3000 - 800) - (((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800)) - (1.5 * ((2000 - 800)/(3000 - 800) - (1100 - 800)/(3000 - 800))))/2]) * (((1+0.1*1 *thrust) * ((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4]) - 0.3 * (1 - 1 *thrust)*((1-1 ) * (speed factor [0, 30]) + 1  * (rpm factor [800,	3600])) - 0.2*((abs(speed)) factor [2, 6]) + 0.2*((abs(speed)) factor [0, 4])*((abs(speed)) factor [0, 4])) + 0.5*(speed factor[0.3,0]) * ((angVelocity factor[0,0.8]) - (rpm factor [800,	3600])) factor [(3000 - 800)/(3000 - 800) - (((3000 - 800)/(3000 - 800) - (2000 - 800)/(3000 - 800)) - (1.5 * ((3000 - 800)/(3000 - 800) - (2000 - 800)/(3000 - 800))))/2, (2000 - 800)/(3000 - 800) + (((3000 - 800)/(3000 - 800) - (2000 - 800)/(3000 - 800)) - (1.5 * ((3000 - 800)/(3000 - 800) - (2000 - 800)/(3000 - 800))))/2])";
            };

            class Engine4_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM4","db-6",1,360 };
                range = "2.5 *230";
            ...
            class Engine5_ext {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_EXT_RPM4","db-5",1,420 };
                range = "2.5 *230";
...
/*
            class Idle_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM0","db-15",1 };
                range = "2.5 *210";
                frequency = "0.9 + ((rpm/7000) factor[(400/7000),(1150/7000)])*0.2";
            ...
            class Engine_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM1","db-14",1 };
                range = "2.5 *215";
                frequency = "0.8 + ((rpm/7000) factor[(900/7000),(2100/7000)])*0.2";
            ...
            class Engine1_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM2","db-12",1 };
                range = "2.5 *215";
                frequency = "0.8 + ((rpm/7000) factor[(1300/7000),(3100/7000)])*0.2";
            ...
            class Engine2_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM3","db-11",1 };
                range = "2.5 *220";
                frequency = "0.8 + ((rpm/7000) factor[(2200/7000),(4100/7000)])*0.2";
            ...
            class Engine3_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM3","db-10",1 };
                range = "2.5 *225";
                frequency = "0.8 + ((rpm/7000) factor[(3300/7000),(4900/7000)])*0.2";
                volume = "engineOn*(1-camPos)*(((rpm/7000) factor[(3250/7000),(4050/7000)])* ((rpm/7000) factor[(4870/7000),(4200/7000)]))";
            };
            class Engine4_int {
                sound[]= { "A3\Sounds_F\vehicles2\soft\Mrap_01\Mrap_01_Engine_INT_RPM4","db-9",1 };
                range = "2.5 *230";
                frequency = "0.8 + ((rpm/7000) factor[(4200/7000),(6200/7000)])*0.2";
...
*/
            ...
            class TiresRockIn {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Rock_Slow_INT","db-6",1 };
                frequency ="1";
                volume ="(1-camPos)*rock*(speed factor[2, 20])";
            };

            class TiresSandIn {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Sand_Slow_INT","db-6",1 };
                frequency ="1";
                volume ="(1-camPos)*sand*(speed factor[2, 20])";
            };

            class TiresGrassIn {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Grass_Slow_INT","db-6",1 };
                frequency ="1";
            ...
            class TiresMudIn
            {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Mud_Slow_INT","db-6",1 };
                frequency ="1";
                volume ="(1-camPos)*mud*(speed factor[2, 20])";
            };

            class TiresGravelIn {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Gravel_Slow_INT","db-6",1 };
                frequency ="1";
                volume ="(1-camPos)*gravel*(speed factor[2, 20])";
            };

            class TiresAsphaltIn {
                sound[]= { "A3\Sounds_F\vehicles2\soft\shared\tires02\Tires_Asphalt_Slow_INT","db-6",1 };
                frequency ="1";
