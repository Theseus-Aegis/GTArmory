...
class CLASS(42Rnd_556x45_M855A1_AUG_Red): CLASS(42Rnd_556x45_M855A1_AUG) {
    displayName = CSTRING(42Rnd_556x45_M855A1_AUG_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};

class CLASS(42Rnd_556x45_M995_AUG): CLASS(42Rnd_556x45_M855A1_AUG) {
    displayName = CSTRING(42Rnd_556x45_M995_AUG_Name);
    ammo = "ACE_556x45_Ball_M995_AP";
};
...
class CLASS(30Rnd_556x45_M855A1_CZ805_Red): CLASS(30Rnd_556x45_M855A1_CZ805) {
    displayName = CSTRING(30Rnd_556x45_M855A1_CZ805_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(25Rnd_556x45_M855A1_Famas_Red): CLASS(25Rnd_556x45_M855A1_Famas) {
    displayName = CSTRING(25Rnd_556x45_M855A1_Famas_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(30Rnd_556x45_M855A1_PMAG_Red): CLASS(30Rnd_556x45_M855A1_PMAG) {
    displayName = CSTRING(30Rnd_556x45_M855A1_PMAG_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(30Rnd_556x45_M855A1_PMAG_Tan_Red): CLASS(30Rnd_556x45_M855A1_PMAG_Tan) {
    displayName = CSTRING(30Rnd_556x45_M855A1_PMAG_Tan_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(30Rnd_556x45_M855A1_EMAG_Red): CLASS(30Rnd_556x45_M855A1_EMAG) {
    displayName = CSTRING(30Rnd_556x45_M855A1_EMAG_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(30Rnd_556x45_M855A1_EMAG_Tan_Red): CLASS(30Rnd_556x45_M855A1_EMAG_Tan) {
    displayName = CSTRING(30Rnd_556x45_M855A1_EMAG_Tan_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
...
class CLASS(60Rnd_556x45_M855A1_Surefire_Red): CLASS(60Rnd_556x45_M855A1_SureFire) {
    displayName = CSTRING(60Rnd_556x45_M855A1_Surefire_Red_Name);
    tracersEvery = 1;
    ammo = QCLASS(556x45_EPR_M856A1_Red);
};
