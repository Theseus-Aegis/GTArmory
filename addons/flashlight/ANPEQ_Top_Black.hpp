...
class CLASS(ANPEQ_15_Top_Laser_Black): cup_acc_anpeq_15_top_flashlight_black_l {
    displayName = CSTRING(ANPEQ_15_Top_Laser_Light_Black_Display);
    MACRO_MULTI_1
...
class CLASS(ANPEQ_15_Top_Light_Black): cup_acc_anpeq_15_top_flashlight_black_f {
    displayName = CSTRING(ANPEQ_15_Top_Laser_Light_Black_Display);
    MACRO_MULTI_2
...
class CLASS(ANPEQ_15_Top_Vis_Laser_Black): cup_acc_anpeq_15_top_flashlight_black_v {
    displayName = CSTRING(ANPEQ_15_Top_Laser_Light_Black_Display);
    MACRO_MULTI_2
